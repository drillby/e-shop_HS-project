...
<body>
	...
	<body>
		...
		if ($_SESSION["nove_heslo_kod_err"] == "")
			$_SESSION["nove_heslo_kod_err"] = "nic";
		?>
		<div class="container">
			<div class="navbar">
				<div class="logo">
				...
				<div class="row">
					...
					<div class="col-2">
						<div class="form-container">
							...
							<form id="RegForm" action="nove_heslo_overeni_script" method="POST">
								<?php
								if ($_SESSION["nove_heslo_kod_err"] == "nespravny_kod")
									echo "<h5>Zadali jste špatný ověřovací kód</h5>";
								?>
								<input type="text" placeholder="Ověřovací kód" name="e_mail_overeni">
