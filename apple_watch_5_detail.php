...
<body>
	<?php
	session_start();
	if (!isset($_SESSION["pocet_produktu_watch_err"]))
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="images/my_gallery-3_1.jpg" width="100%" id="ProductImg">

				<div class="small-img-row">
					<div class="small-img-col">
						<img src="images/my_gallery-3_1.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/my_gallery-3_2.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/my_gallery-3_3.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/my_gallery-3_4.jpg" width="100%" class="small-img">
					</div>
				</div>
			</div>
			...
			<div class="col-2">
				...
				<h1 name="nazev_produktu" class="jmeno_produkt"><?php echo "$produkt_nazev"; ?></h1>
				<h4 name="cena_produktu"><?php echo "$produkt_cena"; ?></h4>
				<form action="e-shop_pridat_do_kosiku_script" method="POST">
					<input type="number" name="kolik" value="1" min="1" max="9">
					<?php
					if ($_SESSION["pocet_produktu_watch_err"] == "true")
				...
				<br>
				<p class="popis">Chytré hodinky - dámské s měřením tepu ze zápěstí, Apple Pay, krokoměr, výpočet kalorií, měření rychlosti, měření vystoupaných pater, měření EKG, GPS, barometr, výškoměr, gyroskop, kompas, senzor pro intenzitu světla, senzor Galileo, připojení pomocí WiFi a Bluetooth, stav baterie, přehrávač hudby, ovládání mobilu, notifikace z mobilu, hledání telefonu, sledování menstruačního cyklu, NFC platby, hodnota vodotěsnosti 50 m (5 ATM), watchOS, kompatibilní s iOS, vyžadují iPhone 6s a novější, kapacita úložiště 32000 MB, ion-x sklíčko, materiál řemínku: silikon, materiál pouzdra: hliník</p>
				<br>
			</div>
		</div>
	</div>
