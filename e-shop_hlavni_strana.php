...
<body>
	...
	<div class="header">
		<div class="container">
			<div class="navbar">
				<div class="logo">
					<a href="e-shop_hlavni_strana.php"><img src="images/logo-white.png" width="125px"></a>
				</div>
			...
			<div class="row">
				<div class="col-2">
					<h1>Děláme technologie<br>ještě dostupnější</h1>
					<p>Nabízíme nejnovější technologiecké zázraky.<br>Od mobilů, hodinek, až po televize a lednice.</p>
					<a href="produkty.php" class="btn">Všechny produkty &#8594;</a>
				</div>
				<div class="col-2">
					<img src="images/my_image1.jpg">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="small-container">
		<br>
		<h2 class="tittle">Nabízené Produkty</h2>
		<div class="row">
			<div class="col-4">
