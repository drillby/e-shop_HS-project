...
<body>
	<?php
	session_start();
	if (!isset($_SESSION["pocet_produktu_lednice_err"]))
	...
	<div class="small-container single-product">
		<div class="row">
			<div class="col-2">
				<img src="images/my_gallery-4_1.jpg" width="100%" id="ProductImg">

				<div class="small-img-row">
					<div class="small-img-col">
						<img src="images/my_gallery-4_1.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/my_gallery-4_2.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/my_gallery-4_3.jpg" width="100%" class="small-img">
					</div>
					<div class="small-img-col">
						<img src="images/my_gallery-4_4.jpg" width="100%" class="small-img">
					</div>
				</div>
			...
			<div class="col-2">
				...
				<form action="e-shop_pridat_do_kosiku_script" method="POST">
					...
					<?php
					if ($_SESSION["pocet_produktu_lednice_err"] == "true")
				...
				<br>
				<p class="popis">Vylepšete svůj kuchyňský dekor s touto lednicí Samsung Frost Free Side by Side. Díky objemu 810 litrů je ideální pro velkou rodinu s více než 5 členy. Má zásuvku FlexZone, která zvládne chladit, ovoce / zeleninu, maso / ryby. Lednice disponuje i vestavěným mrazákem. Invertorový kompresor nastavuje chlazení podle zatížení a šetří energii. Jehí provoz bez stabilizátoru ji chrání před změnami napětí. Na produkt se zvtahuje zátuka 10 let. Kromě toho Triple Cooling automaticky reguluje teplotu ve 3 sekcích, bez míchání pachů.</p>
				<br>
			</div>
		</div>
	</div>
