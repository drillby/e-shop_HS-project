...
<body>
	...
	$adresa = $stat_order . "+" . $mesto_order . "+" . $psc_order . "+" . $ulice_a_cp_order;
	?>
	<div class="container">
		<div class="navbar">
			<div class="logo">
	...
	<div class="account-page">
		<div class="container">
			<div class="row">
				<iframe width="100%" height="500" src="https://maps.google.com/maps?q=<?php echo $adresa; ?>&output=embed"></iframe>
				<a href="objednavka.php" class="btn">Zpět</a>
				<a href="objednavka_shrnuti.php" class="btn">Pokračovat</a>
			</div>
		</div>
	</div>
